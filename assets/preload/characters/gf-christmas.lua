...
function onCreate()
    ...
    makeAnimatedLuaSprite('speaker', 'characters/GF_speaker_W5', getProperty('gf.x') - 190, getProperty('gf.y') + 310)
...
function onUpdate()
    ...
    setProperty('speaker.x', getProperty('gf.x') - 270)
    setProperty('speaker.y', getProperty('gf.y') + 265)
end
